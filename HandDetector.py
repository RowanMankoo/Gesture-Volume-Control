...
class handDetector():
    def __init__(self, min_detection_confidence=0.5, min_tracking_confidence=0.75):
    ...
    def IndexFingerDown(self,frame):
    ...
    def RingFingerDown(self,frame):
        
        
        x1, y1 = self.lmList[16][1], self.lmList[16][2]
        x2, y2 = self.lmList[15][1], self.lmList[15][2]
        x3, y3 = self.lmList[14][1], self.lmList[14][2]
